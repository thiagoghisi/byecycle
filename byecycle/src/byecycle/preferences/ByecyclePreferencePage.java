...
public class ByecyclePreferencePage extends FieldEditorPreferencePage implements
    ...
    public void createFieldEditors() {
        addField(new PackageExcludeListEditor(PreferenceConstants.P_PACKAGE_EXCLUDES,
                "&Packages e&xcluded from dependency graphs:", getFieldEditorParent()));
        addField(new PatternExcludeListEditor(PreferenceConstants.P_PATTERN_EXCLUDES,
                "&Classes excluded from dependency graphs: (regex patterns)", getFieldEditorParent()));
    }
